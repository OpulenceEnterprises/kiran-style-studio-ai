...
const Hero = () => (
  <section className="relative pt-32 md:pt-36 min-h-[70vh] flex flex-col items-center justify-center w-full bg-hero-craft overflow-hidden">
    <div className="absolute inset-0 z-0 pointer-events-none">
      {/* Subtle patterned overlay or subtle illustration could go here */}
    ...
    <div className="relative z-10 max-w-3xl w-full text-center mx-auto pb-8 md:pb-12">
      <h1 className="text-4xl md:text-5xl font-lora font-bold mb-4 text-gray-900 drop-shadow">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-center mb-8">
        ...
        <CTAButton href="#training" variant="secondary">Join Training</CTAButton>
        <CTAButton href="#products" variant="secondary">View Products</CTAButton>
      </div>

      {/* Video intro (YouTube embed/Fake for now) */}
