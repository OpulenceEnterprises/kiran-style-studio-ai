...
export const translations = {
  en: {
    ...
    // Product items
    bridalLehengaTitle: "Bridal Lehenga",
    ...
    traditionalAnarkaliDesc: "Traditional Anarkali suits with modern touches.",
  ...
  hi: {
    ...
    // Product items
    bridalLehengaTitle: "दुल्हन लहंगा",
    ...
    traditionalAnarkaliDesc: "आधुनिक स्पर्श के साथ पारंपरिक अनारकली सूट।",
  ...
  hn: {
    ...
    traditionalAnarkaliTitle: "Traditional Anarkali",
    traditionalAnarkaliDesc: "Modern touches ke saath traditional Anarkali suits.",
